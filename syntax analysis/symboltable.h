...
entry_t *create_entry(char *lexeme, char token_name[20])
{
    entry_t *newentry;
    ...
    strcpy(newentry->token_name , token_name);
...
void insert(entry_t **hash_table_ptr, char *lexeme, char token_name[20])
{
